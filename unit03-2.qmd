...
-   Se usa MCO para estimar la regresión de la primera etapa. $$
    \Var{educ} = \pi_0 + \pi_1 \,\Var{exper} + \pi_2\,\Var{fatheduc} + \pi_3 \,\Var{motheduc} + v.
    $$

-   Se obtienen las predicciones de la explicativa endógena. $$
...
-   La estimación por MCO de la segunda etapa produce estimadores correctos de los parámetros.
