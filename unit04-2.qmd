...
-   Modelo del multiplicador en una economía cerrada y sin sector público.

-   La **forma estructural** se compone de una ecuación de comportamiento y una identidad: $$\begin{align*}C_t &= \alpha + \beta Y_t + u_t \\ Y_t &= C_t + I_t \end{align*}$$

-   Variables endógenas: $C_t$ e $Y_t$. Variable exógena: $I_t$.
...
-   **Condición de completitud**: el sistema de ecuaciones estructural es no singular. En el ejemplo, se debe cumplir que $\beta \neq 1$.
...
-   Los parámetros de la forma estructural miden las relaciones directas entre las variables, *ceteris paribus*.

-   Los parámetros de la forma reducida muestran los efectos directos e indirectos sobre las variables endógenas de cambios en las variables exógenas.

-   Si se cumple la condición de completitud, se puede obtener la forma reducida a partir de la forma estructural.

-   Si se cumplen las condiciones de identificación, se puede recuperar la forma estructural a partir de la forma reducida.
...
-   En un sistema de dos ecuaciones estructurales, requiere que al menos una de las variables exógenas omitidas en una ecuación tenga un parámetro no nulo en la otra ecuación.
...
-   Pueden obtenerse estimaciones más eficientes estimando todos los parámetros de la forma estructural conjuntamente. Pero errores de especificación en una ecuación pueden afectar las estimaciones de las restante ecuaciones.

## Ejemplo: oferta de trabajo de las mujeres casadas

-   Ver Ejemplo 16.3 del manual de Wooldridge.
